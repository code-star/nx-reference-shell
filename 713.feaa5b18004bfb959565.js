"use strict";
(self["webpackChunkdemo"] = self["webpackChunkdemo"] || []).push([[713],{
...
function first(predicate, defaultValue) {
  const hasDefaultValue = arguments.length >= 2;
  return source => source.pipe(predicate ? (0,filter/* filter */.h)((v, i) => predicate(v, i, source)) : identity/* identity */.y, take(1), hasDefaultValue ? defaultIfEmpty(defaultValue) : throwIfEmpty(() => new EmptyError()));
...
var concatMap = __webpack_require__(4612);
...
function resolveData(paramsInheritanceStrategy, moduleInjector) {
  return (0,mergeMap/* mergeMap */.zg)(t => {
    ...
    return (0,from/* from */.D)(canActivateChecks).pipe((0,concatMap/* concatMap */.b)(check => runResolve(check.route, targetSnapshot, paramsInheritanceStrategy, moduleInjector)), (0,tap/* tap */.b)(() => canActivateChecksResolved++), takeLast(1), (0,mergeMap/* mergeMap */.zg)(_ => canActivateChecksResolved === canActivateChecks.length ? (0,of.of)(t) : empty/* EMPTY */.E));
  });
}
...
let Router = /*#__PURE__*/(() => {
  class Router {
    ...
    setupNavigations(transitions) {
      ...
      return transitions.pipe((0,filter/* filter */.h)(t => t.id !== 0), // Extract URL
      ...
      switchMap(t => {
        let completed = false;
        let errored = false;
        return (0,of.of)(t).pipe( // Store the Navigation object
        (0,tap/* tap */.b)(t => {
          ...
          if (processCurrentUrl) {
            ...
            return (0,of.of)(t).pipe( // Fire NavigationStart event
            switchMap(t => {
